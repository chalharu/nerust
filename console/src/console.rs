...
use crate::runner::data::ConsoleData;
use crate::state::StateExport;
use crate::video::ConsoleVideo;
...
pub(crate) struct Crc64Hasher(Digest<'static, u64>);
...
pub(crate) type ConsoleRequestResult = Result<ConsoleReply, ConsoleError>;
