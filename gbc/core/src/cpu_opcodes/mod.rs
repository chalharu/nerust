...
pub(crate) fn handler_table() -> [HandlerFn; 256] {
    ...
    t[0x11] = load::LdR16D16::<1>::exec; // DE
    t[0x12] = load::LdR16memA::<1>::exec;
    t[0x13] = inc_dec::IncR16::<1>::exec;
    ...
    t[0x19] = alu::AddHlR16::<1>::exec;
    t[0x1A] = load::LdAR16mem::<1>::exec;
    t[0x1B] = inc_dec::DecR16::<1>::exec;
    ...
    t[0x21] = load::LdR16D16::<2>::exec;
    t[0x22] = load::LdHliA::exec;
    t[0x23] = inc_dec::IncR16::<2>::exec;
    ...
    t[0x29] = alu::AddHlR16::<2>::exec;
    t[0x2A] = load::LdAHli::exec;
    t[0x2B] = inc_dec::DecR16::<2>::exec;
    ...
    t[0xD1] = stack::Pop::<1>::exec;
    t[0xD5] = stack::Push::<1>::exec;
    ...
    t[0xE1] = stack::Pop::<2>::exec;
    t[0xE2] = misc::LdCA::exec;
    t[0xE5] = stack::Push::<2>::exec;
    ...
    t[0xF1] = stack::Pop::<3>::exec;
    t[0xF2] = misc::LdAC::exec;
    t[0xF3] = misc::Di::exec;
    t[0xF5] = stack::Push::<3>::exec;
