...
pub(crate) fn handler_table() -> [HandlerFn; 256] {
    ...
    t[0x09] = alu::AddHlR16::<{ reg::BC }>::exec;
    t[0x0A] = load::LdAR16mem::<{ reg::BC }>::exec;
    t[0x0B] = inc_dec::DecR16::<{ reg::BC }>::exec;
    t[0x0C] = inc_dec::IncR8::<{ reg::C }>::exec;
    ...
    t[0x15] = inc_dec::DecR8::<{ reg::D }>::exec;
    t[0x16] = load::LdR8D8::<{ reg::D }>::exec;
    t[0x17] = misc::Rla::exec;
    t[0x18] = control::Jr::exec;
    t[0x19] = alu::AddHlR16::<{ reg::DE }>::exec;
    t[0x1A] = load::LdAR16mem::<{ reg::DE }>::exec;
    t[0x1B] = inc_dec::DecR16::<{ reg::DE }>::exec;
    t[0x1C] = inc_dec::IncR8::<{ reg::E }>::exec;
    ...
    t[0x21] = load::LdR16D16::<{ reg::R16_HL }>::exec;
    t[0x22] = load::LdHliA::exec;
    t[0x23] = inc_dec::IncR16::<{ reg::R16_HL }>::exec;
    t[0x24] = inc_dec::IncR8::<{ reg::H }>::exec;
    ...
    t[0x2C] = inc_dec::IncR8::<{ reg::L }>::exec;
    t[0x2D] = inc_dec::DecR8::<{ reg::L }>::exec;
    t[0x2E] = load::LdR8D8::<{ reg::L }>::exec;
    t[0x2F] = misc::Cpl::exec;
    t[0x30] = control::JrCond::<2>::exec;
    t[0x31] = load::LdR16D16::<{ reg::SP }>::exec;
    ...
    t[0x3C] = inc_dec::IncR8::<{ reg::A }>::exec;
    ...
    t[0xD1] = stack::Pop::<{ reg::DE }>::exec;
    t[0xD5] = stack::Push::<{ reg::DE }>::exec;
    ...
    t[0xE1] = stack::Pop::<{ reg::R16_HL }>::exec;
    t[0xE2] = misc::LdCA::exec;
    t[0xE5] = stack::Push::<{ reg::R16_HL }>::exec;
    ...
    t[0xF1] = stack::Pop::<{ reg::AF }>::exec;
    t[0xF2] = misc::LdAC::exec;
    t[0xF3] = misc::Di::exec;
    t[0xF5] = stack::Push::<{ reg::AF }>::exec;
