...
- Included upstream docs:
  - `nes-test-roms/mmc3_irq_tests-readme.txt`
...
- Repository: <https://github.com/pinobatch/little-things-nes/>
- Bundled ROMs:
  - `mmc3bigchrram.nes`
  - `mmc3o_1M_CR32.nes`
  - `mmc3spaminc.nes`
  - `mmc3spaminc-tg.nes`
- Included upstream docs:
  - `little-things-nes/README.md`
  - `little-things-nes/mmc3bigchrram-README.md`
  - `little-things-nes/mmc3o-README.md`
