...
pub trait FilterTypeExt {
    ...
    fn encoded_palette_rgba8(self) -> Box<[u8]>;
    fn ntsc_setup(self) -> Option<Setup>;
    fn shader_kernel_entries(self) -> Option<Box<[ShaderKernelEntry]>>;
    fn packed_kernel_entries(self) -> Option<Box<[u32]>>;
    fn encoded_packed_ntsc_texture_rgba8(self) -> Option<EncodedPackedNtscTexture>;
    fn encoded_ntsc_textures_rgba8(self) -> Option<EncodedNtscTextures>;
}
