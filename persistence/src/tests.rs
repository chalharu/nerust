...
fn test_rom_identity_with_prg_rom_crc64(prg_rom_crc64: u64) -> RomIdentity {
    RomIdentity {
        prg_rom_crc64,
        ..test_rom_identity()
    }
...
fn test_rom_identity_with_format(format: RomFormat) -> RomIdentity {
    RomIdentity {
        format,
        ..test_rom_identity()
    }
...
fn test_rom_identity_with_battery(has_battery: bool) -> RomIdentity {
    RomIdentity {
        has_battery,
        ..test_rom_identity()
    }
...
fn test_rom_identity_with_save_prg_ram_len(save_prg_ram_len: usize) -> RomIdentity {
    RomIdentity {
        save_prg_ram_len,
        ..test_rom_identity()
    }
