...
pub mod input {
    ...
    #[derive(
        Debug, Clone, Copy, PartialEq, Eq, serde_derive::Serialize, serde_derive::Deserialize,
    )]
    #[serde(rename_all = "snake_case")]
...
pub mod desktop {
    ...
    use super::shortcut::ShortcutSettings;
...
mod tests {
    use super::{
        desktop::{AudioSettings, DESKTOP_SETTINGS_SCHEMA_VERSION, DesktopSettings},
        input::KeyboardKey,
