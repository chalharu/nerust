...
impl TryFrom<KeyCode> for Key {
    ...
    fn try_from(code: KeyCode) -> Result<Self, Self::Error> {
        match code {
            ...
            KeyCode::KanaMode => Ok(Key::KanaMode),
            KeyCode::Lang1 => Ok(Key::KanaMode),
            KeyCode::Lang2 => Ok(Key::Eisu),
            KeyCode::Lang3 => Ok(Key::Katakana),
            KeyCode::Lang4 => Ok(Key::Hiragana),
            KeyCode::Lang5 => Ok(Key::ZenkakuHankaku),
...
impl From<Key> for KeyCode {
    fn from(key: Key) -> Self {
        match key {
            ...
            Key::Eisu => KeyCode::Lang2,
            Key::ZenkakuHankaku => KeyCode::Lang5,
