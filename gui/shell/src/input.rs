use nerust_gui_runtime::{
    ControllerInput, ControllerInputs, ControllerPort, GuiSession, InputState,
};
...
mod tests {
    ...
    use nerust_gui_runtime::{ControllerInput, ControllerInputs, ControllerPort, InputState};
