...
pub fn conflicting_keys(settings: &DesktopSharedSettings) -> BTreeMap<KeyboardKey, Vec<String>> {
    ...
    {
        for descriptor in descriptors::keyboard_binding_descriptors() {
...
mod tests {
    ...
    fn detects_conflicts_across_controls_and_shortcuts() {
        ...
        let conflicts = conflicting_keys(&settings);
